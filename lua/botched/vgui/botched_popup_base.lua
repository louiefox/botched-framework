...
function PANEL:Init()
    ...
    self.mainPanel.Paint = function( self2, w, h )
        BOTCHED.FUNC.BeginShadow( "popup_" .. self.headerText )
        BOTCHED.FUNC.SetShadowSize( "popup_" .. self.headerText, w, h )
        local x, y = self2:LocalToScreen( 0, 0 )
        draw.RoundedBox( 8, x, y, w, h, BOTCHED.FUNC.GetTheme( 1 ) )			
        BOTCHED.FUNC.EndShadow( "popup_" .. self.headerText, x, y, 1, 2, 2, 255, 0, 0, false )
    end
